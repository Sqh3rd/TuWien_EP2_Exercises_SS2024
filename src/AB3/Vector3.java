...
public class Vector3
{
    ...
    public void drawAsFilledCircle(CodeDraw cd, double radius) {
        double x = cd.getWidth() * (this.x + AB1.Simulation.SECTION_SIZE / 2) / AB1.Simulation.SECTION_SIZE;
        double y = cd.getWidth() * (this.y + AB1.Simulation.SECTION_SIZE / 2) / AB1.Simulation.SECTION_SIZE;
