...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nFirst test basic functions as in AB7:");
        ...
        System.out.println("\nNow some extensions of AB8:");
        System.out.println("Test 'iterator' and 'remove':");
        int count = 0;
        ...
        testValue(count, 12);
        testValue(solarSystem.getNumberOfBodies(), 9);
        testEquals(solarSystem.toString().trim(), targetSolar.trim());
    ...
    /**
     * Checks two objects for identity and prints "Successful test" only if
